...
describe Board do
    let(:board) {Board.new}    
    let(:initial_symbol) {initial_symbol = ['1'.red, '2'.red, '3'.red, '4'.red, '5'.red, '6'.red, '7'.red, '8'.red, '9'.red]}
    let(:later_symbol) {initial_symbol = ['1'.red, '2'.red, 'X', '4'.red, '5'.red, '6'.red, '7'.red, '8'.red, '9'.red]}

    describe "initialize" do
        it "retruns the initial board object with initial symbol values" do                          
            expect(board.symbol).to eql(initial_symbol) 
        end
    end 
