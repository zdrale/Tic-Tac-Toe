...
describe TicTacToe do
    let(:playboard) {Board.new}
    let(:player1) {Player.new('Henok', 'X')}    
    let(:player2) {Player.new('Nikola', 'O')}    
    let(:game) {TicTacToe.new}    
    let(:current_player) {player1}
    let(:next_player) {player2}

    let(:board_symbol) {board_symbol = ['1'.red, '2'.red, '3'.red, '4'.red, '5'.red, '6'.red, '7'.red, '8'.red, '9'.red]}
    let(:board_print) {board_print = "#{:board_symbol[0]} | #{:board_symbol[1]} | #{:board_symbol[2]} \r\n---------- \r\n#{:board_symbol[3]} | #{:board_symbol[4]} | \
    {:board_symbol[5]} \r\n---------- \r\n#{:board_symbol[6]} | #{:board_symbol[7]} | #{:board_symbol[8]}\r\n"}
    
    describe "create_players" do   
        let(:players) {players = game.create_players('Henok', 'Nikola', 'X', 'O')}
    ...
    describe "check_move?" do 
        let(:test_symbol) {test_symbol = ['1'.red, 'X', 'O', 'X', '5'.red, '6'.red, '7'.red, '8'.red, '9'.red]}
